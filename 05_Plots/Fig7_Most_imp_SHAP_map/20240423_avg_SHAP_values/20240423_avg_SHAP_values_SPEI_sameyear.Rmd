---
title: "Average SHAP values (SPEI_sameyear)"
...
tic.clearlog()
# load 2018 SHAP df: 430.77 sec elapsed
...
tic.clearlog()
# load 2019 SHAP df: 237.6 sec elapsed
...
tic.clearlog()
# load 2020 SHAP df: 309.67 sec elapsed
...
tic.clearlog()
# load 2021 SHAP df: 439.81 sec elapsed
...
tic.clearlog()
# load 2022 SHAP df: 244.95 sec elapsed
...
# save this df 
write.csv(merged_SHAPdf, "D:/Nextcloud/Documents/CliWaC/05_RESULTS/20240423_mean_SHAP_dfs/SPEI_sameyear_mean_SHAP_df.csv", row.names = FALSE)
...
TEST = read.csv("D:/Nextcloud/Documents/CliWaC/05_RESULTS/20240423_mean_SHAP_dfs/SPEI_sameyear_mean_SHAP_df.csv")
...
minValue(SHAP_r) # -0.4207668
maxValue(SHAP_r) # 0.6448879
