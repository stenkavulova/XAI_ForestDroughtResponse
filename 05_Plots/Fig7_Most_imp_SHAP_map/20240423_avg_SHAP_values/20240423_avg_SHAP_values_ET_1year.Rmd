---
title: "Average SHAP values (ET_1year)"
...
tic.clearlog()
# load 2018 SHAP df: 430.24 sec elapsed
...
tic.clearlog()
# load 2019 SHAP df: 237.72 sec elapsed
...
tic.clearlog()
# load 2020 SHAP df: 307.94 sec elapsed
...
tic.clearlog()
# load 2021 SHAP df: 434.46 sec elapsed
...
tic.clearlog()
# load 2022 SHAP df: 243.42 sec elapsed
...
# save this df 
write.csv(merged_SHAPdf, "D:/Nextcloud/Documents/CliWaC/05_RESULTS/20240423_mean_SHAP_dfs/ET_1year_mean_SHAP_df.csv", row.names = FALSE)
...
TEST = read.csv("D:/Nextcloud/Documents/CliWaC/05_RESULTS/20240423_mean_SHAP_dfs/ET_1year_mean_SHAP_df.csv")
...
minValue(SHAP_r) # -0.4069258
maxValue(SHAP_r) # 0.2935002
