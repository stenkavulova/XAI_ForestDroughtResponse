---
title: "SHAP figure for ET_1year and 2018"
...
You need to add 1 to the predictor column number (see below); for example `19. ET_1year` in the `trainX_df` is column 20 in the SHAP dfs (because first column in SHAP dfs is the modelled class).
...
# [1] "ag_prox"              "aspect"               "bdod"                 "broadleaf_perc"       "canopyheight"        
#  [6] "cec"                  "cfvo"                 "clay"                 "elevation"            "forest_prox"         
# [11] "AWC"                  "nitrogen"             "ocd"                  "ocs"                  "sand"                
# [16] "silt"                 "slope"                "soc"                  "TCD"                  "TWI"                 
# [21] "water_prox"           "airtemp_sameyear"     "ET_sameyear"          "rad_direct_sameyear"  "SMI_sameyear"        
# [26] "SPEI_sameyear"        "SSM_sameyear"         "SWI_15cm_sameyear"    "groundwater_sameyear" "gw_trend_sameyear"   
# [31] "LST_sameyear"         "airtemp_1year"        "ET_1year"             "groundwater_1year"    "gw_trend_1year"      
# [36] "LST_1year"            "rad_direct_1year"     "SMI_1year"            "SPEI_1year"           "SSM_1year"           
# [41] "SWI_15cm_1year"      
...
# top_pred_names = c("TCD", "broadleaf_perc", "ET_1year", "ET_1year", "ET_1year")
# 
...
# ET_1year is column 33 originally, so it is column 34 here
# because first column here is the predicted classes, then the SHAP values for the predictors

shap_df <- data.table::fread(shap_df_path, select = 34, header = TRUE)
...
#just column 1 
#load SHAP df: 3.46 sec sec elapsed
#Rows: 10,406,171
#Columns: 1
...
# the reason I converted to lonlat is to include the scalebar (it didn't work with the other projection)
...
minValue(SHAP_r) # -1.191563
maxValue(SHAP_r) # 0.772863
...
png("D:/Nextcloud/Documents/CliWaC/05_RESULTS/20240422_SHAP_predictor_maps/20240423_ET_1year_SHAP_plots/ET_1year_SHAP_map_2018.png", width = 8, height =7, units = "in", res = 300)
