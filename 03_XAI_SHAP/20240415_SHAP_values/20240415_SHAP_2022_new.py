...
os.chdir("E:/Data/Vulova/Topic_1/04_PROCESSED_DATA/20240415_SHAP_2022_new")

os.getcwd()

name = 'X_all_2022'  # Define the name of the data file to be processed
...
def process_data(name, i):
    ...
    model = joblib.load('E:/Data/Vulova/Topic_1/04_PROCESSED_DATA/20240415_SHAP_2022_new/model_100K_allyears_20240415.pkl')
