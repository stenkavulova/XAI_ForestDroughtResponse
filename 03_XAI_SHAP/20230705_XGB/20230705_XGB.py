...
X_train, X_test, y_train, y_test = train_test_split(X, y_encoded, test_size=0.2, random_state=19, stratify=y)
...
print("Training Accuracy:", train_accuracy) # 0.9978916639636718
print("Testing Accuracy:", test_accuracy) #Testing Accuracy: 0.7970168612191959
...
#
#           0       0.70      0.64      0.67       498
#           1       0.84      0.87      0.85      1044

#    accuracy                           0.80      1542
#   macro avg       0.77      0.76      0.76      1542
#weighted avg       0.79      0.80      0.79      1542
...
plt.savefig('D:/Stenka_Cliwac/Topic_1/12_PYTHON/20230705_XGB/20230705_confusion_matrix.png', dpi=300, bbox_inches='tight')
