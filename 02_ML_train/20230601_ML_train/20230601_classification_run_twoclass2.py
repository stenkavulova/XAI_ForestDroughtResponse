...
mask = (df["NDVI_categories"] == "small_increase") | (df["NDVI_categories"] == "large_increase") | (df["NDVI_categories"] == "small_decrease")
...
print("Accuracy:", accuracy) # Accuracy: 0.6365
...
#large_decrease       0.61      0.74      0.67      2000
#     no_change       0.67      0.54      0.60      2000
