...
# Next, I am going to try to make this a 2-class classification problem.
# >-10 = damaged
# -10 to 10 = no change
...
thresholds = [-np.inf, -10, 10, np.inf]
categories = ["decrease", "no_change", "increase"]
...
mask = (df["NDVI_categories"] == "increase")
...
print("Accuracy:", accuracy) # Accuracy: 0.58225
...
#               precision    recall  f1-score   support
 ...
 #   decrease       0.55      0.84      0.67      2000
  # no_change       0.67      0.32      0.43      2000

 #   accuracy                           0.58      4000
 #  macro avg       0.61      0.58      0.55      4000
#weighted avg       0.61      0.58      0.55      4000
