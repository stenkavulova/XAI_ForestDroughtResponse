...
#           0       0.62      0.45      0.52     50000
#           1       0.57      0.72      0.64     50000

#    accuracy                           0.59    100000
#   macro avg       0.59      0.59      0.58    100000
#weighted avg       0.59      0.59      0.58    100000

#%% Save the model 

# Save the trained model to a file
joblib.dump(model, 'D:/Stenka_Cliwac/Topic_1/12_PYTHON/20231221_100K_ML_test/model_100K_LO2022.pkl')

# To load the model later
loaded_model = joblib.load('D:/Stenka_Cliwac/Topic_1/12_PYTHON/20231221_100K_ML_test/model_100K_LO2022.pkl')
