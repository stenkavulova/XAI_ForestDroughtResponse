...
df_2018 = pd.read_csv("D:/Stenka_Cliwac/Topic_1/04_PROCESSED_DATA/20231219_mod_dfs_reduced/100K/sub_df_100K_2018.csv")
print(df_2018["NDMI_classes"].value_counts())

df_2019 = pd.read_csv("D:/Stenka_Cliwac/Topic_1/04_PROCESSED_DATA/20231219_mod_dfs_reduced/100K/sub_df_100K_2019.csv")
print(df_2019["NDMI_classes"].value_counts())

df_2020 = pd.read_csv("D:/Stenka_Cliwac/Topic_1/04_PROCESSED_DATA/20231219_mod_dfs_reduced/100K/sub_df_100K_2020.csv")
print(df_2020["NDMI_classes"].value_counts())

df_2021 = pd.read_csv("D:/Stenka_Cliwac/Topic_1/04_PROCESSED_DATA/20231219_mod_dfs_reduced/100K/sub_df_100K_2021.csv")
print(df_2021["NDMI_classes"].value_counts())

df_2022 = pd.read_csv("D:/Stenka_Cliwac/Topic_1/04_PROCESSED_DATA/20231219_mod_dfs_reduced/100K/sub_df_100K_2022.csv")
...
#           0       0.58      0.78      0.67     50000
#           1       0.67      0.43      0.53     50000

#    accuracy                           0.61    100,000
#   macro avg       0.62      0.61      0.60    100000
#weighted avg       0.62      0.61      0.60    100000

#%% Save the model 

# Save the trained model to a file
joblib.dump(model, 'D:/Stenka_Cliwac/Topic_1/12_PYTHON/20231221_100K_ML_test/model_100K_LO2019.pkl')

# To load the model later
loaded_model = joblib.load('D:/Stenka_Cliwac/Topic_1/12_PYTHON/20231221_100K_ML_test/model_100K_LO2019.pkl')
