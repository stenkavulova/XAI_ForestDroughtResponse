...
# I will randomly downsample all years to be the same size (in this example: 2M/ year). That means 5K of each class per year. 
...
df_2018 = pd.read_csv("D:/Stenka_Cliwac/Topic_1/04_PROCESSED_DATA/20231219_mod_dfs_reduced/2M/sub_df_2M_2018.csv")
print(df_2018["NDMI_classes"].value_counts())

df_2019 = pd.read_csv("D:/Stenka_Cliwac/Topic_1/04_PROCESSED_DATA/20231219_mod_dfs_reduced/2M/sub_df_2M_2019.csv")
print(df_2019["NDMI_classes"].value_counts())

df_2020 = pd.read_csv("D:/Stenka_Cliwac/Topic_1/04_PROCESSED_DATA/20231219_mod_dfs_reduced/2M/sub_df_2M_2020.csv")
print(df_2020["NDMI_classes"].value_counts())

df_2021 = pd.read_csv("D:/Stenka_Cliwac/Topic_1/04_PROCESSED_DATA/20231219_mod_dfs_reduced/2M/sub_df_2M_2021.csv")
print(df_2021["NDMI_classes"].value_counts())

df_2022 = pd.read_csv("D:/Stenka_Cliwac/Topic_1/04_PROCESSED_DATA/20231219_mod_dfs_reduced/2M/sub_df_2M_2022.csv")
...
# all dfs except 2019 (used for testing)

# List of DataFrames
dfs = [df_2018, df_2020, df_2021, df_2022]
...
# 2019 is left out and used for testing 

# Prepare the data by separating the predictors (X) and the target variable (y)
X_test = df_2019.drop(["x", "y", "NDMI_classes", "Year_NDMI_anom", "NDMI_anomaly"], axis=1) # predictors 
# X has 41 columns (exactly correct - 41 predictors)

y_test_raw = df_2019["NDMI_classes"] # response variable 
...
# X_train: (8,000,000, 41)
# y_train: (8000000,)
# X_valid: (2,000,000, 41)
# y_valid: (2000000,)
...
# Execution time: 443.56 seconds (7 min. 23 seconds)
...
#           0       0.59      0.53      0.56   1000000
#           1       0.58      0.64      0.60   1000000

#    accuracy                           0.58   2,000,000
#   macro avg       0.59      0.58      0.58   2000000
#weighted avg       0.59      0.58      0.58   2000000

#%% Save the model 

# Save the trained model to a file
joblib.dump(model, 'D:/Stenka_Cliwac/Topic_1/12_PYTHON/20231221_2M_ML_test/model_2M_LO2019.pkl')

# To load the model later
loaded_model = joblib.load('D:/Stenka_Cliwac/Topic_1/12_PYTHON/20231221_2M_ML_test/model_2M_LO2019.pkl')
