...
#           0       0.62      0.53      0.57   1000000
#           1       0.59      0.68      0.63   1000000

#    accuracy                           0.60   2,000,000
#   macro avg       0.61      0.60      0.60   2,000,000
#weighted avg       0.61      0.60      0.60   2000000

#%% Save the model 

# Save the trained model to a file
joblib.dump(model, 'D:/Stenka_Cliwac/Topic_1/12_PYTHON/20231221_2M_ML_test/model_2M_LO2022.pkl')

# To load the model later
loaded_model = joblib.load('D:/Stenka_Cliwac/Topic_1/12_PYTHON/20231221_2M_ML_test/model_2M_LO2022.pkl')
