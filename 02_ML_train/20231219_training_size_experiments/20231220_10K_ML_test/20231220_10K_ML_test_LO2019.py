...
# I will randomly downsample all years to be the same size (in this example: 10K/ year). That means 5K of each class per year. 
...
df_2018 = pd.read_csv("D:/Stenka_Cliwac/Topic_1/04_PROCESSED_DATA/20231219_mod_dfs_reduced/10K/sub_df_10K_2018.csv")
print(df_2018["NDMI_classes"].value_counts())

df_2019 = pd.read_csv("D:/Stenka_Cliwac/Topic_1/04_PROCESSED_DATA/20231219_mod_dfs_reduced/10K/sub_df_10K_2019.csv")
print(df_2019["NDMI_classes"].value_counts())

df_2020 = pd.read_csv("D:/Stenka_Cliwac/Topic_1/04_PROCESSED_DATA/20231219_mod_dfs_reduced/10K/sub_df_10K_2020.csv")
print(df_2020["NDMI_classes"].value_counts())

df_2021 = pd.read_csv("D:/Stenka_Cliwac/Topic_1/04_PROCESSED_DATA/20231219_mod_dfs_reduced/10K/sub_df_10K_2021.csv")
print(df_2021["NDMI_classes"].value_counts())

df_2022 = pd.read_csv("D:/Stenka_Cliwac/Topic_1/04_PROCESSED_DATA/20231219_mod_dfs_reduced/10K/sub_df_10K_2022.csv")
...
#           0       0.60      0.25      0.36      5000
#           1       0.53      0.83      0.64      5000

#    accuracy                           0.54     10000
#   macro avg       0.56      0.54      0.50     10000
#weighted avg       0.56      0.54      0.50     10000