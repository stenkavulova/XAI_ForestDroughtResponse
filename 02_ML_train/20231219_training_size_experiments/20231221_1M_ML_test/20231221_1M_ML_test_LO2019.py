...
#           0       0.59      0.69      0.64    500000
#           1       0.63      0.52      0.57    500000

#    accuracy                           0.61   1000000
#   macro avg       0.61      0.61      0.60   1000000
#weighted avg       0.61      0.61      0.60   1,000,000

#%% Save the model 

# Save the trained model to a file
joblib.dump(model, 'D:/Stenka_Cliwac/Topic_1/12_PYTHON/20231221_1M_ML_test/model_1M_LO2019.pkl')

# To load the model later
loaded_model = joblib.load('D:/Stenka_Cliwac/Topic_1/12_PYTHON/20231221_1M_ML_test/model_1M_LO2019.pkl')
