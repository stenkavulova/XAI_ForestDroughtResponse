...
tif_files = glob.glob('D:/Stenka_Cliwac/Topic_1/04_PROCESSED_DATA/20230319_scaled_MODIS_NDVI/2022-08*.tif')
print(len(tif_files))
print(tif_files)
...
# Write output file
with rasterio.open('D:/Stenka_Cliwac/Topic_1/04_PROCESSED_DATA/20230320_monthly_MODIS_NDVI/2022_08_MODIS_NDVI_avg.tif', 'w', **meta) as dst:
...
# The raster properties are imported instantly.
# The raster data, however, are not automatically imported, as they are potentially very large and memory-consuming.
src = rasterio.open('D:/Stenka_Cliwac/Topic_1/04_PROCESSED_DATA/20230320_monthly_MODIS_NDVI/2022_08_MODIS_NDVI_avg.tif')
