---
title: "Performance metrics (2018)"
...
true_class_df = read.csv("E:/Data/Vulova/Topic_1/04_PROCESSED_DATA/20240415_dfs_true_class/true_class_2018.csv")

toc()

tictoc::tic.clearlog()
# load true class: 38.74 sec elapsed
...
csv_file <- "E:/Data/Vulova/Topic_1/04_PROCESSED_DATA/20240415_SHAP_2018_new/X_all_2018_SHAP.csv"
...
tictoc::tic.clearlog()
# load modeled class: 2.91 sec elapsed
...
train_2018_100k <- "E:/Data/Vulova/Topic_1/04_PROCESSED_DATA/20240415_mod_dfs_100K_new/sub_df_100K_2018_new.csv"
...
coord_2018_100k <- data.table::fread(train_2018_100k, select = c(1,2,3,46,47), header = TRUE)
head(coord_2018_100k)

# Add same columns as in true_class_df
#coord_2018_100k$true_class <- 1
#coord_2018_100k$mod_class <- 1

# Convert coord_2018_100k to a data frame
coord_2018_df <- as.data.frame(coord_2018_100k)
...
# Identify rows in true_class_df that are not present in coord_2018_100k
subset <- anti_join(true_class_df, coord_2018_100k, by = c('coord_code'))
nrow(subset) # 10,306,171 it worked! 
