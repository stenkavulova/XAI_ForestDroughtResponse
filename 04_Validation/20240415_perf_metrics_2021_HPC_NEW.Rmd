---
title: "Performance metrics (2021)"
...
true_class_df = read.csv("E:/Data/Vulova/Topic_1/04_PROCESSED_DATA/20240415_dfs_true_class/true_class_2021.csv")

toc()

tictoc::tic.clearlog()
# load true class: 36.24 sec elapsed
...
csv_file <- "E:/Data/Vulova/Topic_1/04_PROCESSED_DATA/20240415_SHAP_2021_new/X_all_2021_SHAP.csv"
...
tictoc::tic.clearlog()
# load modeled class: 2.86 sec elapsed
...
train_2021_100k <- "E:/Data/Vulova/Topic_1/04_PROCESSED_DATA/20240415_mod_dfs_100K_new/sub_df_100K_2021_new.csv"
...
coord_2021_100k <- data.table::fread(train_2021_100k, select = c(1,2,3,46,47), header = TRUE)
head(coord_2021_100k)

# Add same columns as in true_class_df
#coord_2021_100k$true_class <- 1
#coord_2021_100k$mod_class <- 1

# Convert coord_2021_100k to a data frame
coord_2021_df <- as.data.frame(coord_2021_100k)
...
# Identify rows in true_class_df that are not present in coord_2021_100k
subset <- anti_join(true_class_df, coord_2021_100k, by = c('coord_code'))
nrow(subset) # 9,524,727 it worked! 
...
# test <- broom::tidy(conf_matrix_prec_recall)
