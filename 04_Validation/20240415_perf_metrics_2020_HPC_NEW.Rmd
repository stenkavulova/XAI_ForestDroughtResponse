---
title: "Performance metrics (2020)"
...
true_class_df = read.csv("E:/Data/Vulova/Topic_1/04_PROCESSED_DATA/20240415_dfs_true_class/true_class_2020.csv")

toc()

tictoc::tic.clearlog()
# load true class: 38.41 sec elapsed
...
csv_file <- "E:/Data/Vulova/Topic_1/04_PROCESSED_DATA/20240415_SHAP_2020_new/X_all_2020_SHAP.csv"
...
train_2020_100k <- "E:/Data/Vulova/Topic_1/04_PROCESSED_DATA/20240415_mod_dfs_100K_new/sub_df_100K_2020_new.csv"
...
coord_2020_100k <- data.table::fread(train_2020_100k, select = c(1,2,3,46,47), header = TRUE)
head(coord_2020_100k)

# Add same columns as in true_class_df
#coord_2020_100k$true_class <- 1
#coord_2020_100k$mod_class <- 1

# Convert coord_2020_100k to a data frame
coord_2020_df <- as.data.frame(coord_2020_100k)
...
# Identify rows in true_class_df that are not present in coord_2020_100k
subset <- anti_join(true_class_df, coord_2020_100k, by = c('coord_code'))
nrow(subset) # 10,334,985 it worked! 
