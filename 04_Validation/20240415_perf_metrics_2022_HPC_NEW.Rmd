---
title: "Performance metrics (2022)"
...
true_class_df = read.csv("E:/Data/Vulova/Topic_1/04_PROCESSED_DATA/20240415_dfs_true_class/true_class_2022.csv")

toc()

tictoc::tic.clearlog()
# load true class: 37.47 sec elapsed
...
csv_file <- "E:/Data/Vulova/Topic_1/04_PROCESSED_DATA/20240415_SHAP_2022_new/X_all_2022_SHAP.csv"
...
tictoc::tic.clearlog()
# load modeled class: 3.11 sec elapsed
...
train_2022_100k <- "E:/Data/Vulova/Topic_1/04_PROCESSED_DATA/20240415_mod_dfs_100K_new/sub_df_100K_2022_new.csv"
...
coord_2022_100k <- data.table::fread(train_2022_100k, select = c(1,2,3,46,47), header = TRUE)
head(coord_2022_100k)

# Add same columns as in true_class_df
#coord_2022_100k$true_class <- 1
#coord_2022_100k$mod_class <- 1

# Convert coord_2022_100k to a data frame
coord_2022_df <- as.data.frame(coord_2022_100k)
...
# Identify rows in true_class_df that are not present in coord_2022_100k
subset <- anti_join(true_class_df, coord_2022_100k, by = c('coord_code'))
nrow(subset) # 10,332,546 it worked! 
